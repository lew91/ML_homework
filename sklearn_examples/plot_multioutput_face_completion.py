...
# fit estimators
ESTIMATORS = {
    "Extra tress": ExtraTreesRegressor(n_estimators=10, max_features=32,
                                       random_state=0),
    "K-nn": KNeighborsRegressor(),
    "Linear regression": LinearRegresseion(),
    "Ridge": RidgeCV(),
}
...
for i in range(n_faces):
    ...
    for j, est in enumerate(sorted(ESTIMATORS)):
        ...
        if i:
            ...
            sub = plt.subplot(n_faces, n_cols, i * n_cols + 2 + j, tilte=est)
