...
# mapping from integer feature name to orginal token string
if opts.use_hashing:
    feature_names = None
else:
...
if opts.select_chi2:
    print("Extracting %d best feature by a chi-squared test" % opts.select_chi2)
    t0 = time()
...
def benchmark(clf):
    ...
    train_time = time() - t0
    print("trian time: %0.3fs" % train_time)
